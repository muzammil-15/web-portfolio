...
export default function Service({ title, desc, image }) {
  return (
    <section className=" w-full  bg-button  shadow-sm shadow-[#5e5b5b] flex flex-col gap-6 p-6 justify-center items-center lative card   overflow-hidden h-[250px] md:h-[310px] sm:w-[80%] md:w-[40%] lg:w-[30%] rounded-[10px]  bg-contain bg-center" >
