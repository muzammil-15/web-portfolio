  ...
  return (
    <Drawer className="w-full">
      <DrawerTrigger className="w-full relative  overflow-hidden h-[300px]  rounded-lg bg-contain bg-center">
          ...
          <div className="w-full h-full bg-[#1d1d1d28] z-50 absolute top-0 left-0">
            <h1 className="absolute bottom-5 left-2 uppercase heading font-[700] tracking-wider opacity-6">{title.slice(0,40)}</h1>
